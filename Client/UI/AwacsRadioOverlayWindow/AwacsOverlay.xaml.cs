...
//
        ...
        private void ToggleGlobalSimultaneousTransmissionButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (dcsPlayerRadioInfo != null)
            {
                ...
                ToggleGlobalSimultaneousTransmissionButton.Content = _clientStateSingleton.PlayerRadioInfo.simultaneousTransmission ? "Simul. Transmission ON" : "Simul. Transmission OFF";
                ToggleGlobalSimultaneousTransmissionButton.Foreground = _clientStateSingleton.PlayerRadioInfo.simultaneousTransmission ? new SolidColorBrush(Colors.Orange) : new SolidColorBrush(Colors.White);
