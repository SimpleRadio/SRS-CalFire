...
//
//                             if (radioId < _clientStateSingleton.PlayerUnitState.Radios.Length)
//                             {
...
//                                             (RadioConfig.Modulation) udpVoicePacket.Modulations[i],
...
//                                                 || radio.Modulation == RadioConfig.Modulation.MIDS // IGNORE LOS and Distance for MIDS - we assume a Link16 Network is in place
//                                                 || globalFrequency
//                                                 || (
...
//                                                 decryptable =
//                                                     (udpVoicePacket.Encryptions[i] == 0) ||
//                                                     (udpVoicePacket.Encryptions[i] == radio.EncryptionKey && radio.EncryptionEnabled);
//
...
//                                                     false,
//                                                     audio.Volume,(RadioConfig.Modulation) audio.Modulation);
//                                                 
//                                             }
//
//                                             var transmitterName = "";
...
//                 //check global
//                 && !globalFrequencies.Any(freq => PlayerUnitState.FreqCloseEnough(receivingRadio.ReceivingRadio.Frequency, freq))
...
//             {
//                 radiosWithRetransmit = radiosWithRetransmit.Where(radio => !PlayerUnitState.FreqCloseEnough(radio.Frequency, receivingRadio.Frequency));
//             }
//
...
//             {
//                 frequencies[i] = finalList[i].Frequency;
//                 encryptions[i] = finalList[i].EncryptionEnabled ? (byte)finalList[i].EncryptionKey:(byte)0 ;
...
//
//             if (currentRadio.Modulation == RadioConfig.Modulation.FM 
//                 || currentRadio.Modulation == RadioConfig.Modulation.AM 
//                 || currentRadio.Modulation == RadioConfig.Modulation.MIDS 
//                 || currentRadio.Modulation == RadioConfig.Modulation.HAVEQUICK)
//             {
...
//                     if ( (radio.Modulation == RadioConfig.Modulation.FM || radio.Modulation == RadioConfig.Modulation.AM )&& radio.SimultaneousTransmission &&
...
//             {
//                 if (radioInfo.Radios[0].Modulation == RadioConfig.Modulation.INTERCOM)
//                 {
...
//                     && currentSelected < _clientStateSingleton.PlayerUnitState.Radios.Length)
//                 {
...
//                                                        RadioConfig.Modulation.DISABLED
//                                                        && (currentlySelectedRadio.Frequency > 100 ||
//                                                            currentlySelectedRadio.Modulation ==
//                                                            RadioConfig.Modulation.INTERCOM))
//                     {
...
//                     if (currentSelected == 0 && currentlySelectedRadio.Modulation == RadioConfig.Modulation.INTERCOM && _clientStateSingleton.PlayerUnitState.inAircraft == false)
//                     {
...
//                     {
//                         if (radio != null && radio.SimultaneousTransmission && radio.Modulation != RadioConfig.Modulation.DISABLED
//                             && (radio.Frequency > 100 || radio.Modulation == RadioConfig.Modulation.INTERCOM)
...
//                             {
//                                 if (frequencies[j] == radio.Frequency
//                                     && modulations[j] == (byte) radio.Modulation
//                                     && encryptions[j] == (radio.EncryptionEnabled ? radio.EncryptionKey : (byte) 0))
//                                 {
...
//                             }
//
//                             frequencies.Add(radio.Frequency);
//                             encryptions.Add(radio.EncryptionEnabled ? radio.EncryptionKey : (byte) 0);
...
//                                 currentlySelectedRadio.EncryptionEnabled && (currentlySelectedRadio.EncryptionKey > 0),
