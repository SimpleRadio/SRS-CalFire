...
using Ciribob.SRS.Client.Network.DCS.Models;
        ...
        private bool UpdateRadio(PlayerRadioInfo message)
        {
            ...
            for (var i = 0; i < playerRadioInfo.radios.Length; i++)
            {
                ...
                else
                {
                    ...
                    if (playerRadioInfo.simultaneousTransmissionControl == PlayerRadioInfo.SimultaneousTransmissionControl.EXTERNAL_DCS_CONTROL)
                    { 
            ...
            if (playerRadioInfo.simultaneousTransmissionControl ==
                PlayerRadioInfo.SimultaneousTransmissionControl.EXTERNAL_DCS_CONTROL)
            {
