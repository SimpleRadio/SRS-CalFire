...
namespace NAudio.MediaFoundation
{
    ...
    public class MediaType
    {
        ...
        {
            this.MediaFoundationObject = mediaType;
        }
        ...
        public MediaType()
        {
            MediaFoundationObject = MediaFoundationApi.CreateMediaType();
        }
        ...
        {
            MediaFoundationObject = MediaFoundationApi.CreateMediaTypeFromWaveFormat(waveFormat);
        }
        ...
        public int SampleRate
        {
            ...
            set => MediaFoundationObject.SetUINT32(MediaFoundationAttributes.MF_MT_AUDIO_SAMPLES_PER_SECOND, value);
        }
        ...
        public int ChannelCount
        {
            ...
            set => MediaFoundationObject.SetUINT32(MediaFoundationAttributes.MF_MT_AUDIO_NUM_CHANNELS, value);
        }
        ...
        public int BitsPerSample
        {
            ...
            set => MediaFoundationObject.SetUINT32(MediaFoundationAttributes.MF_MT_AUDIO_BITS_PER_SAMPLE, value);
        }
        ...
        public Guid SubType
        {
            ...
            set => MediaFoundationObject.SetGUID(MediaFoundationAttributes.MF_MT_SUBTYPE, value);
        }
        ...
        public Guid MajorType
        {
            ...
            set => MediaFoundationObject.SetGUID(MediaFoundationAttributes.MF_MT_MAJOR_TYPE, value);
        }
        ...
        /// </summary>
        public IMFMediaType MediaFoundationObject { get; }

        private int GetUInt32(Guid key)
        {
            int value;
            MediaFoundationObject.GetUINT32(key, out value);
            return value;
        }
        ...
        {
            Guid value;
            MediaFoundationObject.GetGUID(key, out value);
            return value;
        }
        ...
        public int TryGetUInt32(Guid key, int defaultValue = -1)
        {
            ...
            try
            {
                MediaFoundationObject.GetUINT32(key, out intValue);
            }
