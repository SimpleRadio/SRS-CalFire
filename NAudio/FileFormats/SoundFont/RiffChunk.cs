...
namespace NAudio.FileFormats.SoundFont
{
    internal class RiffChunk
    {
        ...
        public string ChunkID
        {
            ...
            set
            {
                if (value == null) throw new ArgumentNullException("ChunkID may not be null");

                if (value.Length != 4) throw new ArgumentException("ChunkID must be four characters");
        ...
        public string ReadChunkID()
        {
            ...
            if (cid.Length != 4) throw new InvalidDataException("Couldn't read Chunk ID");
        ...
        public T[] GetDataAsStructureArray<T>(StructureBuilder<T> s)
        {
            ...
            for (var n = 0; n < structuresToRead; n++) a[n] = s.Read(riffFile);
