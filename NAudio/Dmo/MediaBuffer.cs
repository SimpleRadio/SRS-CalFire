...
namespace NAudio.Dmo
{
    ...
    public class MediaBuffer : IMediaBuffer, IDisposable
    {
        ...
        public int Length
        {
            ...
            set
            {
                if (length > maxLength) throw new ArgumentException("Cannot be greater than maximum buffer size");
        ...
        int IMediaBuffer.SetLength(int length)
        {
            ...
            if (length > maxLength) return HResult.E_INVALIDARG;
        ...
        int IMediaBuffer.GetBufferAndLength(IntPtr bufferPointerPointer, IntPtr validDataLengthPointer)
        {
            ...
            if (bufferPointerPointer != IntPtr.Zero) Marshal.WriteIntPtr(bufferPointerPointer, buffer);
