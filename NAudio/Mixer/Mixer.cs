...
namespace NAudio.Mixer
{
    ...
    public class Mixer
    {
        private readonly MixerInterop.MIXERCAPS caps;
        ...
        {
            if (mixerIndex < 0 || mixerIndex >= NumberOfDevices) throw new ArgumentOutOfRangeException("mixerID");
        ...
        public static IEnumerable<Mixer> Mixers
        {
            get
            {
                for (var device = 0; device < NumberOfDevices; device++) yield return new Mixer(device);
            }
        }
