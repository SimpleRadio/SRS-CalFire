...
namespace NAudio.Mixer
{
    ...
    public class MixerLine
    {
        ...
        private readonly MixerInterop.MIXERLINE mixerLine;
        ...
        public bool IsDisconnected =>
            (mixerLine.fdwLine & MixerInterop.MIXERLINE_LINEF.MIXERLINE_LINEF_DISCONNECTED) != 0;
        ...
        public IEnumerable<MixerLine> Sources
        {
            get
            {
                for (var source = 0; source < SourceCount; source++) yield return GetSource(source);
            }
        }
        ...
        {
            if (sourceIndex < 0 || sourceIndex >= SourceCount) throw new ArgumentOutOfRangeException("sourceIndex");
