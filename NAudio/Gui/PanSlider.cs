...
namespace NAudio.Gui
{
    ...
    public class PanSlider : UserControl
    {
        ...
        protected override void OnPaint(PaintEventArgs pe)
        {
            ...
            {
                pe.Graphics.FillRectangle(Brushes.Orange, Width / 2, 1, (int)(Width / 2 * pan),
                    Height - 2);
                panValue = string.Format("{0:F0}%R", pan * 100);
            }
            else
            {
                pe.Graphics.FillRectangle(Brushes.Orange, (int)(Width / 2 * (pan + 1)), 1,
                    (int)(Width / 2 * (0 - pan)), Height - 2);
        ...
        {
            if (e.Button == MouseButtons.Left) SetPanFromMouse(e.X);
