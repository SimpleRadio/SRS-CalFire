...
namespace NAudio.Wave.SampleProviders
{
    ...
    public class MultiplexingSampleProvider : ISampleProvider
    {
        ...
        public MultiplexingSampleProvider(IEnumerable<ISampleProvider> inputs, int numberOfOutputChannels)
        {
            ...
            if (this.inputs.Count == 0) throw new ArgumentException("You must provide at least one input");

            if (numberOfOutputChannels < 1) throw new ArgumentException("You must provide at least one output");
            ...
            for (var n = 0; n < OutputChannelCount; n++) mappings.Add(n % InputChannelCount);
        }
