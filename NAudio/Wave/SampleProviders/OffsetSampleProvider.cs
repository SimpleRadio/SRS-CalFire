...
namespace NAudio.Wave.SampleProviders
{
    ...
    public class OffsetSampleProvider : ISampleProvider
    {
        ...
        public int DelayBySamples
        {
            ...
            set
            {
                if (phase != 0) throw new InvalidOperationException("Can't set DelayBySamples after calling Read");
        ...
        public int SkipOverSamples
        {
            ...
            set
            {
                if (phase != 0) throw new InvalidOperationException("Can't set SkipOverSamples after calling Read");
        ...
        public int TakeSamples
        {
            ...
            set
            {
                if (phase != 0) throw new InvalidOperationException("Can't set TakeSamples after calling Read");
        ...
        public int LeadOutSamples
        {
            ...
            set
            {
                if (phase != 0) throw new InvalidOperationException("Can't set LeadOutSamples after calling Read");
        ...
        public int Read(float[] buffer, int offset, int count)
        {
            ...
            if (phase == 1) // delay
            {
                ...
                for (var n = 0; n < delaySamples; n++) buffer[offset + n] = 0;
            ...
            if (phase == 4) // lead out
            {
                ...
                for (var n = 0; n < samplesRequired; n++) buffer[offset + samplesRead + n] = 0;
