...
namespace NAudio.Wave
{
    ...
    public class AiffFileReader : WaveStream
    {
            ...
            out int dataChunkLength, List<AiffChunk> chunks)
        {
            ...
            if (ReadChunkName(br) != "FORM") throw new FormatException("Not an AIFF file - no FORM header.");
            ...
            while (br.BaseStream.Position < br.BaseStream.Length)
            {
                ...
                if (br.BaseStream.Position + nextChunk.ChunkLength > br.BaseStream.Length) break;
                ...
                {
                    if (chunks != null) chunks.Add(nextChunk);

                    br.BaseStream.Position += nextChunk.ChunkLength;
                }
            }

            if (format == null) throw new FormatException("Invalid AIFF file - No COMM chunk found.");

            if (dataChunkPosition == -1) throw new FormatException("Invalid AIFF file - No SSND chunk found.");
        }
        ...
        public override int Read(byte[] array, int offset, int count)
        {
            ...
            lock (lockObject)
            {
                ...
                if (Position + count > dataChunkLength) count = dataChunkLength - (int)Position;
