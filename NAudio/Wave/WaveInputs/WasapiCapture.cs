...
namespace NAudio.CoreAudioApi
{
    ...
    public class WasapiCapture : IWaveIn
    {
        ...
        /// <param name="captureDevice">The capture device.</param>
        /// <param name="useEventSync">true if sync is done with event. false use sleep.</param>
        /// <param name="audioBufferMillisecondsLength">
        ///     Length of the audio buffer in milliseconds. A lower value means lower
        ///     latency but increased CPU usage.
        /// </param>
        ...
        public virtual WaveFormat WaveFormat
        {
            get =>
                ...
                waveFormat.AsStandardWaveFormat();
        ...
        private void DoRecording(AudioClient client)
        {
            ...
            while (captureState == CaptureState.Capturing)
            {
                ...
                if (readBuffer) ReadNextPacket(capture);
            }
        }
