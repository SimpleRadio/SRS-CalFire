...
namespace NAudio.Wave
{
    ...
    public class WaveInEvent : IWaveIn
    {
        ...
        private void CreateBuffers()
        {
            ...
            for (var n = 0; n < buffers.Length; n++) buffers[n] = new WaveInBuffer(waveInHandle, bufferSize);
        }

        private void OpenWaveInDevice()
        {
            CloseWaveInDevice();
            var result = WaveInterop.waveInOpenWindow(out waveInHandle, (IntPtr)DeviceNumber, WaveFormat,
                ...
                if (callbackEvent.WaitOne())
                    ...
                    foreach (var buffer in buffers)
                        if (buffer.Done)
                        {
                            ...
                            if (captureState == CaptureState.Capturing) buffer.Reuse();
                        }
        }
        ...
        private void CloseWaveInDevice()
        {
            ...
            if (buffers != null)
            {
                for (var n = 0; n < buffers.Length; n++) buffers[n].Dispose();
