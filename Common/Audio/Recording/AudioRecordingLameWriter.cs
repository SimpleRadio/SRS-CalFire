...
namespace Ciribob.FS3D.SimpleRadio.Standalone.Common.Audio.Recording
{
    internal class AudioRecordingLameWriter
    {
        ...
        private List<OggStream> _mp3FileWriters;
        ...
        public AudioRecordingLameWriter(List<AudioRecordingStream> streams, int sampleRate, int maxSamples)
        {
           ...
           // _mp3FileWriters = new List<OggVorbisEncoder>();
        ...
        public void Start()
        {
            ...
            for (int i = 0; i < _streams.Count; i++)
            {
                ...
                //TODO
              //  _mp3FileWriters.Add(new OggStream(_mp3FilePaths[i], _waveFormat, lamePreset));
            }
        }
